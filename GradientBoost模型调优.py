...
y = None
# 目标函数
def gb_cv(n_estimators, min_samples_split, max_features, max_depth,min_samples_leaf):
    ...
    scores = cross_val_score(gb, x, y,cv=10, scoring= make_scorer(f1_score, average = 'micro') ).mean()
    return scores
...
if __name__ =='__main__':
    ...
    # 贝叶斯优化
    gb_bo = BayesianOptimization(gb_cv,
            {'n_estimators': (10, 500),
    ...
    gb_bo.maximize(init_points=20, n_iter=200)# 抽取多少个初始观测值/总共观测/迭代次数
    print(gb_bo.res)
